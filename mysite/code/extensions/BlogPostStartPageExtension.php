...
class BlogPostStartPageExtension extends DataExtension {
	...
	public function updateCMSFields(FieldList $fields) {
		...
		$fields->addFieldToTab('Root.Main', TagField::create('StartPages', 'Department', StartPage::get())->setCanCreate(true)->setDescription('The post will show up on the above department(s) start page'), 'Content');
